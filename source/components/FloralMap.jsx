...
import floralFields from "../constants/floralFields";
...
const FloralMap = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            {
                type === 'map' ? (
                    <View style={{width: '100%', height: 485, marginTop: height * 0.1}}>
                        <Image source={require('../assets/decor/floralMap.png')} style={styles.map} />
                        {
                            floralFields.map((item, index) => (
                                <View 
                                    key={index} 
                                    style={[ {position: 'absolute'},
                                        index === 0 && {bottom: height * 0.57, left: 20},
                                        index === 1 && {bottom: height * 0.5, right: 0},
                                        index === 2 && {bottom: height * 0.26, left: 100},
                                        index === 3 && {bottom: height * 0.23, right: 0},
